...
export default function AboutPage() {
  ...
  return (
    <main
      ref={sectionRef}
      className="bg-gradient-to-b from-gray-50 to-white section-padding overflow-hidden"
    >
      <div className="container-custom max-w-6xl">
              ...
              {[
                {
                  ...
                  desc: "High-quality materials with modern finishing and durability.",
                },
                {
                  icon: Briefcase,
                  title: "Honest Service",
                  desc: "Trusted service with transparent pricing and timely delivery.",
                },
                {
                  icon: Users,
                  title: "1000+ Clients",
                ...
                },
                {
                  ...
                  desc: "Professional support and quality craftsmanship.",
                },
              ].map((item, index) => (
                <div
                  key={item.title}
